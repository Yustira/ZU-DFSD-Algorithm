...
In this repository we are succesfully create the algorithm based on both methods. This repository includes of the main code of ZU and DFSD algorithm that can be running from terminal, command prompt, or IDE that you prefered. Also we included the basic concept and formulation of both methods to help you understanding those methods.
